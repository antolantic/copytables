...
var mouseButtonNames = [
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:16
function modifiers(mode) {
  ...
  return keyboard.mouseModifiers
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:27
    .map(function (m) {
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:38
function copyFormats() {
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:51
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:58
function load() {
  dom.findOne("#copy-formats").innerHTML = copyFormats();

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:61
  dom.find("[data-modifiers]").forEach(function (el) {
    el.innerHTML = modifiers(dom.attr(el, "data-modifiers"));
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:65
  dom.find("[data-bool]").forEach(function (el) {
    el.checked = !!preferences.val(dom.attr(el, "data-bool"));
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:69
  dom.find("[data-select]").forEach(function (el) {
    el.checked =
      preferences.val(dom.attr(el, "data-select")) ===
      dom.attr(el, "data-select-value");
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:75
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:81
function save() {
  var prefs = {};

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:84
  dom.find("[data-modifier]").forEach(function (el) {
    var code = Number(dom.attr(el, "data-modifier")),
      mode = dom.attr(el, "data-mode");
    prefs["modifier." + mode] =
      (prefs["modifier." + mode] || 0) | (el.checked ? code : 0);
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:91
  dom.find("[data-bool]").forEach(function (el) {
    prefs[dom.attr(el, "data-bool")] = !!el.checked;
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:95
  dom.find("[data-select]").forEach(function (el) {
    if (el.checked)
      prefs[dom.attr(el, "data-select")] = dom.attr(el, "data-select-value");
  });

 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:100
  dom.find("[data-text]").forEach(function (el) {
 ...
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:108
window.onload = function () {
  ...
  event.listen(window, {
    input: save,
    change: save,
 // C:\Users\Nous\Documents\Devt\FirefoxExtensions\copytables\src\options.js:114
    click: function (e) {
